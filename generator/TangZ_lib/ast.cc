...
//   {} virtual llvm::BasicBlock emit() = 0; virtual void print() {
//   printf("Stmt\n StmtCatgry: %d\n", StmtCatgry); };
// };
...
//   Expr() = default;
//   Expr(llvm::Type *type, llvm::Value *value, tz_ast_type::ExprCatgry
//   ExprCatgry)
...
//   InitListExpr(llvm::Type *type, bool isInited, std::vector<Expr *>
//   initExprs)
...
//         isInited(isInited),
//         InitExpr(InitExpr) {}
//   VarDecl(llvm::LLVMContext &llvm_context, const llvm::json::Object
//   *json_tree); llvm::BasicBlock emit() override; void print() override {
//     printf("VarDecl, isConst: %d, isInited: %d, InitExpr: ", isConst,
//     isInited); InitExpr->print(); printf("Finish VarDecl\n");
//   };
// };

// class ParmVarDecl : public VarDecl {
//  public:
//   ParmVarDecl(std::string name, llvm::Type *type, bool isConst, bool
//   isInited,
//               Expr *InitExpr)
...
//   bool external;
//   Stmt *FuncStmt;
//   FunctionDecl(std::string name, llvm::Type *type, std::vector<Decl *>
//   params,
//                bool isVariadic)
//       : Decl(std::move(name), type),
...
//         ThenObj(ThenObj),
//         ElseObj(ElseObj) {}
//   IfStmt(llvm::LLVMContext &llvm_context, const llvm::json::Object
//   *json_tree); llvm::BasicBlock emit() override; void print() override {
...
//   DoStmt(llvm::LLVMContext &llvm_context, const llvm::json::Object
//   *json_tree); llvm::BasicBlock emit() override; void print() override {
